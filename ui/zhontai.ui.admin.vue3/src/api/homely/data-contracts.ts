...
/** 分页信息输入 */
export interface PageInputThingTagGetPageInput {
  /**
   * 当前页标
   * @format int32
   */
...
/** 分页信息输出 */
export interface PageOutputThingTagGetPageOutput {
  /**
   * 数据总数
   * @format int64
   */
  total?: number
  /** 数据 */
  list?: ThingTagGetPageOutput[] | null
}
...
/** 结果输出 */
export interface ResultOutputPageOutputThingTagGetPageOutput {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
  ...
  msg?: string | null
  /** 分页信息输出 */
  data?: PageOutputThingTagGetPageOutput
}
...
/** 结果输出 */
export interface ResultOutputThingTagGetOutput {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 物品标签列表查询条件输入 */
export interface ThingTagGetListInput {
  /** 标签名称 */
  name?: string | null
}
...
/** 物品标签分页查询条件输入 */
export interface ThingTagGetPageInput {
  /** 标签名称 */
  name?: string | null
}
